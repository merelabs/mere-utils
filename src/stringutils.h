...
namespace Mere::Utils
{
    ...
    struct MERE_UTILS_LIB_SPEC StringUtils
    {
        ...
        static unsigned long indexOf(const std::string& str, const std::string &sub, unsigned int occurrence = 1);

        static std::vector<std::string> split(const std::string &str, char delim = ' ');
        static std::string join(const std::list<std::string> &list, char delim = ' ');
